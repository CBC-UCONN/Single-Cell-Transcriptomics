...
## Doublet Detection
- Can be filtered out using tools like the `scDblFinder` R package 
...
- There is no differential expression, only a difference in sequencing depth
...
- Scran's pooling-based size factor estimation method
  - Works well for batch correction  
...
- We want to:
  - Select genes that capture biologically meaningful variation 
...
## Integration - Harmony <img src="img/harmony-logo.png" style="height:2.5em; vertical-align:middle; margin-left:0.5em;">
